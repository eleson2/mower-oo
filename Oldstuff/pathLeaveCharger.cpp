#include <Arduino.h>
#include <./patterns/pathLeaveCharger.h>

 
mLeaveCharger::mLeaveCharger(Scheduler* aS, unsigned int mSec) 
          : DrivePattern(mSec,TASK_FOREVER,aS,false) {
};

mLeaveCharger::~mLeaveCharger(){};

bool mLeaveCharger::Callback() { 
...
bool mLeaveCharger::OnEnable() { 
    seQno = 0;

    return true; 
};
void mLeaveCharger::OnDisable() { 
  //ForwardCut;
};
